...
- The Gemini `generate_content` API does not expose pixel-precise output sizing; this node applies `resolution`/`width`+`height` as a post-resize of the returned image.
